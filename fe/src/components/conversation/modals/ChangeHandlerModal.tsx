...
interface ChangeHandlerModalProps {
  isOpen: boolean
  onClose: () => void
...
const mockUsers = [
  ...
  { id: 'unassigned', name: 'Unassigned', email: '', role: 'unassigned' },
]

export const ChangeHandlerModal = ({
  isOpen,
  onClose,
  onChange,
  currentHandler,
}: ChangeHandlerModalProps) => {
          ...
          {currentHandler && (
            ...
            >
              <Text fontSize="xs" color="blue.700">
                Current: <Text as="span" fontWeight="medium">{currentHandler}</Text>
              </Text>
            </Box>
          )}
              ...
              filteredUsers.map((user) => (
                ...
                >
                  <Box
                    w={8}
                    h={8}
                    bg={user.role === 'unassigned' ? 'gray.100' : 'blue.100'}
                    borderRadius="full"
                    display="flex"
                    alignItems="center"
                    justifyContent="center"
                  >
                    <User size={16} color={user.role === 'unassigned' ? '#6B7280' : '#2563EB'} />
                  </Box>
